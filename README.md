...
**nf-core/scrnaseq** is a bioinformatics best-practice analysis pipeline for A pipeline for single cell RNAseq analysis.
...
nf-core/scrnaseq was originally written by Jianhong Ou.
